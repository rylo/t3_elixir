defmodule GameSetup do
  ...
  def make_players(player_1_type // ask_for_player_type("X"), player_2_type // ask_for_player_type("O") ) do
    [Player.new(type: player_1_type, marker: :x), 
     Player.new(type: player_2_type, marker: :o)]
  end
